    ...
    <div class="container modal__body" id="login-modal">
        ...
        <section class="wrapper">
            ...
            <?php if ($error_message) { ?>
                <div class="tweet-form__error"><?php echo $error_message; ?></div>
            <?php } ?>
            <div class="tweet-form__subtitle">Если у вас нет логина, пройдите <a href="<?php echo get_url('register.php') ?>">регистрацию</a></div>
            <form class="tweet-form"  action="<?php echo get_url('includes/sing_in.php'); ?>" method="POST">
...
<?php if($error_message) echo '<script>openModal()</script>'; ?>
</body>
